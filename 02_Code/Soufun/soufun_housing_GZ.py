...
areas = {"-a073":"天河", "-a074":"海珠", "-a076":"白云", "-a072":"越秀",
		 "-a078":"番禺", "-a071":"荔湾", "-a0639":"花都", "-a075":"黄埔",
		 "-a080":"增城", "-a084":"南沙", "-a079":"从化", "从化":"佛山",
		 "-a08015":"中山", "-a08016":"东莞", "-a08017":"清远"}
         
baseURL = "http://zu.gz.fang.com/house{0}/c2{1}-d2{2}-h34-i3{3}/"
        ...
        if step <= minStep:
            ...
            for city in areas.keys():
                ...
                for j in range(2,int(pagesCity)+1):
                    ...
                    print "page number completed: " + "(" + str(areas[city]) + ") " + str(j)
