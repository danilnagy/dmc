...
areas = {"-a085":"Fukuda", "-a087":"Nanshan", "-a086":"Luohu", "-a089":"Baoan",
		 "-a090":"Longgang", "-a088":"Salt Pan", "-a013057":"Dongguan", "-a013058":"Huizhou"}
         
baseURL = "http://zu.sz.fang.com/house{0}/c2{1}-d2{2}-h34-i3{3}/"
